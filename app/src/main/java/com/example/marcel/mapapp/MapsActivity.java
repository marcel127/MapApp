...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        LocationChange=this.getIntent().getExtras().getBoolean("change");
    ...
    public void enterToDataBase(){
        ref = data.getInstance().getReference("Users");

        ref .child(userName).setValue(new LOCATION2D(""+Latitude,""+Longitude));
